...
function excercise10() {
  ...
  const figureRect = new Rectangle(10, 20);

  // console.log(figureRect.getArea());
  // console.log(figureRect.getPerimeter());
}
// TODO: compile and run the code
excercise10();
...
function excercise11() {
  ...
  const firstStack = new Stack<number>();

  firstStack.push(1);
  firstStack.push(5);

  console.log(firstStack.pop()?.toFixed());
  ...
  console.log(secondStack.pop()?.toUpperCase());
}
// TODO: compile and run the code
excercise11();
...
function excercise12() {
  ...
  const randomedNumb = (numbsArr: number[]): number => {
    return numbsArr[Math.floor(Math.random() * numbsArr.length)];
  };

  console.log(randomedNumb([1, 2, 3, 4, 5]));
  console.log(randomedNumb([1, 2, 3, 4, 5]));

  const randomedStr = (strArr: string[]): string => {
    return strArr[Math.floor(Math.random() * strArr.length)];
  };

  console.log(randomedStr(["one", "two", "three", "four", "five"]));
  console.log(randomedStr(["one", "two", "three", "four", "five"]));

  const randomedObj = (objArr: object[]): object => {
  ...
  const randomedAny = <T>(objArr: T[]): T => {
    return objArr[Math.floor(Math.random() * objArr.length)];
  };

  console.log(randomedAny(["one", 2, { pos: "three" }]));
  console.log(randomedAny(["one", 2, { pos: "three" }]));
}
// TODO: compile and run the code
excercise12();
...
function excercise15() {
  ...
  users.forEach((user: TUser): void => console.log(user.name));
}
// TODO: compile and run the code
excercise15();
...
function excercise16() {
  ...
  // Nothing changed after deleting global.d.ts. i used this:
