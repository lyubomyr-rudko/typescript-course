...
function exercise17() {
  ...
  class Student {
    ...
    printStudent(): string {
      return `Info about student: name - ${this.name}, age - ${this.age}, id - ${this.studentId}`;
    }
  }
  const student = new Student('Serhii', 32, 234532);
  console.log(student.printStudent());
  // student.studentId = 9098787; // causes an arror after assigning readonly property
}
...
function exercise19() {
  function formatCommandLine(command: string | string[] | boolean): string {
