...
function exercise23() {
  ...
  type TPassanger = TAnimal | THuman;
  ...
  type TPassangerV2 = Human | Animal;
  const humanV2 = new Human("Misha", 32, "KO-326-183");
  const animalV2 = new Animal("El Nino", 18, "Ostrich");
  function printPassangerInfoV2(passanger: TPassangerV2): void {
  ...
  printPassangerInfoV2(humanV2);
  printPassangerInfoV2(animalV2);
}
...
function exercise28() {
  ...
  class WidgetWithSize extends Widget implements IWidgetWithSize, IWidgetPrintable {
    width: number;
    height: number;
    color: string;
  ...
  class DesktopWidget extends WidgetWithSize implements IDesktopWidget, IWidgetPrintable {
    os: string;
  ...
  class MobileWidget extends DesktopWidget implements IMobileWidget, IWidgetPrintable {
    space: number;
    constructor(
      name: string,
      width: number,
